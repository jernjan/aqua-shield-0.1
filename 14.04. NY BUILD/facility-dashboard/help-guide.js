...
class HelpGuide {
    ...
    baseContent.sections = [
      {
        ...
        content: 'Rød = smittet, Oransje = BarentsWatch-zone, Gul = lokal smitteradius, Grønn = frisk. Klikk på anlegg for detaljer.'
      },
      {
  ...
  getFacilityHelp(baseContent) {
    ...
    baseContent.sections = [
      ...
      },
      {
        ...
        content: 'Interaktivt kart. Drag for å bevege, scroll for å zoome. Klikk anlegg for info. Oransje = ILA protection-sone, amber = ILA surveillance-sone.'
      },
      {
  ...
  getVesselHelp(baseContent) {
    ...
    baseContent.sections = [
      ...
      {
        title: '📍 Kart',
        content: 'Grønn = frisk anlegg, Rød = smittet, Orange = BarentsWatch-risiko. Klikk for å legge til i rute.'
      },
      {
